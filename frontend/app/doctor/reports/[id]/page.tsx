...
export default function ReportViewPage() {
    ...
    const originalImageUrl = report.scan?.imageUrl;
    const isFallbackOriginal = typeof originalImageUrl === "string" && originalImageUrl.includes("scan-placeholder");
    const hasOriginalImage = Boolean(originalImageUrl) && !isFallbackOriginal;
    ...
    return (
        <div className="max-w-4xl mx-auto py-8">
            ...
            <div ref={printRef} className="bg-cream-50 rounded-[20px] shadow-lg border border-sage-300 overflow-hidden print:shadow-none print:border-none print:rounded-none">
                ...
                {/* Scan Image + Heatmap */}
                {(report.scan?.imageUrl || report.scan?.heatmapUrl) && (
                        ...
                        <div className="flex gap-4 items-start">
                            <div className="flex-1">
                                ...
                                <div className="bg-olive-900 rounded-xl overflow-hidden">
                                    {hasOriginalImage ? (
                                        <img src={originalImageUrl} alt="Scan" className="w-full max-h-[300px] object-contain" />
                                    ) : (
                                        <div className="h-[300px] flex items-center justify-center px-6 text-center text-sm text-sage-200">
                                            Original scan is unavailable for this historical report.
                                        </div>
                                    )}
                                </div>
                            </div>
