    ...
    <div className="min-h-screen w-full relative flex items-center justify-center bg-[#F6F8F3] overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <motion.div
          ...
          className="absolute -top-32 -left-20 w-[550px] h-[550px] bg-black rounded-full blur-3xl"
        />
        <motion.div
          animate={{
            scale: [1, 1.2, 1],
          ...
          className="absolute -bottom-20 -right-32 w-[500px] h-[500px] bg-[#9BCF53] rounded-full blur-3xl"
        />
        <motion.div
          animate={{
            scale: [1, 1.18, 1],
          ...
          className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[420px] h-[420px] bg-white rounded-full blur-3xl"
        />
      </div>
      ...
      >
        ...
        >
          ...
          <h1 className="text-4xl font-black text-black mb-3 leading-tight">Join VaidyaVision</h1>
        ...
        >
          ...
          <div className="absolute -inset-1 bg-gradient-to-r from-black via-[#9BCF53] to-white rounded-[28px] opacity-0 group-hover:opacity-30 blur-xl transition-opacity duration-700" />
